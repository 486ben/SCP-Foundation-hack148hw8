const hauntings = class {
  ...
  static textReplacement(intensity, data){
    console.log(" text be replaced" )
    let phrases = ["Shit!", "<strong>", "</strong>"];
    if (data.pagesVisited["SCP Lab level 1"])
      phrases.push("<strong>WARNING: SCP HAD BEEN HACKING NOW!</strong>")
    if (data.pagesVisited["SCP Lab level 2"])
      phrases.push("<strong>WARNING: SCP HAD BEEN HACKING NOW!</strong>")
    if (data.pagesVisited["SCP Lab level 2"])
